...
from .views import debug_reset_database, ChartCreateListView, ChartRetrieveUpdateDestroy, DatasourceCreateListView, DatasourceRetrieveUpdateDestroy
...
urlpatterns = [
    ...
    path('datasources/<pk>/', DatasourceRetrieveUpdateDestroy.as_view(), name='datasource-get'),
]
if DEBUG:
